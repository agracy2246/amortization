...
/**
 * This class stores loan information and creates a text file containing an
 * amortization report.
 */
...
public class Amortization {
   ...
   /**
    * The constructor accepts the loan amount, the annual interest rate, and the
    * number of years of the loan as arguments. The private method CalcPayment is
    * then called.
    * 
   ...
   /**
    * The calcPayment method calculates the monthly payment amount. The result is
    * stored in the payment field.
    */
   ...
   /**
    * The getNumberOfPayments method returns the total number of payments to be
    * made for the loan.
    * 
   ...
   /**
    * The saveReport method saves the amortization report to the file named by the
    * argument.
    * 
   ...
   public void saveReport(String filename) throws IOException {
      ...
      for (int month = 1; month <= getNumberOfPayments(); month++) {
         ...
         outputFile.println(month + "\t" + dollar.format(monthlyInterest) + "\t\t" + dollar.format(principal) + "\t\t"
